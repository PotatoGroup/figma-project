...
function buildSimplifiedEffects(n) {
  if (!(0, _identity.hasValue)("effects", n)) return {};
...
function simplifyDropShadow(effect) {
  var _effect$spread;
  return "".concat(effect.offset.x, "px ").concat(effect.offset.y, "px ").concat(effect.radius, "px ").concat((_effect$spread = effect.spread) !== null && _effect$spread !== void 0 ? _effect$spread : 0, "px ").concat((0, _style.formatRGBAColor)(effect.color));
}
function simplifyInnerShadow(effect) {
  var _effect$spread2;
  return "inset ".concat(effect.offset.x, "px ").concat(effect.offset.y, "px ").concat(effect.radius, "px ").concat((_effect$spread2 = effect.spread) !== null && _effect$spread2 !== void 0 ? _effect$spread2 : 0, "px ").concat((0, _style.formatRGBAColor)(effect.color));
}
