...
exports.downloadFigmaImage = downloadFigmaImage;
 ...
 */
function downloadFigmaImage(_x, _x2, _x3) {
  return _downloadFigmaImage.apply(this, arguments);
}
/**
 ...
 */
function _downloadFigmaImage() {
  _downloadFigmaImage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(fileName, localPath, imageUrl) {
    var _response$body, fullPath, response, writer, reader, errorMessage;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          fullPath = _path.default.join(localPath, fileName); // Use fetch to download the image
          _context2.next = 5;
        ...
        case 8:
          // Create write stream
          writer = _fs.default.createWriteStream(fullPath); // Get the response as a readable stream and pipe it to the file
        ...
        case 12:
          return _context2.abrupt("return", new Promise(function (resolve, reject) {
                ...
                return _regeneratorRuntime().wrap(function _callee$(_context) {
                  while (1) switch (_context.prev = _context.next) {
                    ...
                    case 15:
                      ...
                      writer.end();
                      _fs.default.unlink(fullPath, function () {});
                      reject(_context.t0);
                    case 20:
                    case "end":
            ...
            writer.on("error", function (err) {
              reader.cancel();
              _fs.default.unlink(fullPath, function () {});
              reject(new Error("Failed to write image: ".concat(err.message)));
            });
            processStream();
          }));
        case 15:
          ...
          throw new Error("Error downloading image: ".concat(errorMessage));
        case 19:
        case "end":
...
function removeEmptyKeys(input) {
  ...
  for (var key in input) {
    if (Object.prototype.hasOwnProperty.call(input, key)) {
      ...
      if (cleanedValue !== undefined && !(Array.isArray(cleanedValue) && cleanedValue.length === 0) && !(_typeof(cleanedValue) === "object" && cleanedValue !== null && Object.keys(cleanedValue).length === 0)) {
...
function generateVarId() {
  var prefix = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "var";
  ...
  return "".concat(prefix, "_").concat(result);
}
...
function generateCSSShorthand(values) {
  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
    _ref$ignoreZero = _ref.ignoreZero,
    ignoreZero = _ref$ignoreZero === void 0 ? true : _ref$ignoreZero,
    _ref$suffix = _ref.suffix,
    suffix = _ref$suffix === void 0 ? "px" : _ref$suffix;
  var top = values.top,
    right = values.right,
  ...
  if (top === right && right === bottom && bottom === left) {
    return "".concat(top).concat(suffix);
  }
  if (right === left) {
    if (top === bottom) {
      return "".concat(top).concat(suffix, " ").concat(right).concat(suffix);
    }
    return "".concat(top).concat(suffix, " ").concat(right).concat(suffix, " ").concat(bottom).concat(suffix);
  }
  return "".concat(top).concat(suffix, " ").concat(right).concat(suffix, " ").concat(bottom).concat(suffix, " ").concat(left).concat(suffix);
}
...
function isVisible(element) {
  var _element$visible;
  return (_element$visible = element.visible) !== null && _element$visible !== void 0 ? _element$visible : true;
}
