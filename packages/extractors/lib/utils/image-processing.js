...
exports.applyCropTransform = applyCropTransform;
exports.downloadAndProcessImage = downloadAndProcessImage;
exports.generateImageCSSVariables = generateImageCSSVariables;
 ...
 */
function applyCropTransform(_x, _x2) {
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return Promise.resolve().then(function () {
            return _interopRequireWildcard(require("./logger.js"));
          });
        case 2:
          ...
          image = (0, _sharp.default)(imagePath);
          _context.next = 14;
        ...
        case 28:
          ...
          _fs.default.renameSync(tempPath, imagePath);
...
function getImageDimensions(_x3) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          _context2.prev = 4;
          _context2.next = 7;
          return (0, _sharp.default)(imagePath).metadata();
        case 7:
 ...
 */
function downloadAndProcessImage(_x4, _x5, _x6) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 5:
          ...
          _context3.next = 10;
          return Promise.resolve().then(function () {
            return _interopRequireWildcard(require("./common.js"));
          });
        case 10:
...
function generateImageCSSVariables(_ref) {
