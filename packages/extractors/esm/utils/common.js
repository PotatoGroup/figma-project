 ...
 */
export function downloadFigmaImage(_x, _x2, _x3) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          fullPath = path.join(localPath, fileName); // Use fetch to download the image
          _context2.next = 5;
        ...
        case 8:
          // Create write stream
          writer = fs.createWriteStream(fullPath); // Get the response as a readable stream and pipe it to the file
